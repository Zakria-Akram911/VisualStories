...
const cardData = [
  ...
  },
  {
    ...
    type: "premium",
    content:
      "Break free from limitations and create as many enchanting stories as your heart desires.",
    price: paidImage,
    privileges: [
...
const PaymentAndSubscriptionMain = () => {
  ...
  return (
    <Grid
      ...
      sx={{
        maxWidth: isMobile ? "90%" : mediumScreen ? "70%" : "65%",
        m: "0 auto",
      }}
    >
      <Grid
        item
        className="payment-heading-main"
        xs={12}
        m={isMobile ? "0px 0px 20px" : mediumScreen ? "0px 0px 20px" : "30px 0px"}
      >

...
const myStoriesData: Story[] = [
  {
    ...
    shortDesc:
      "James takes us on a swashbuckling adventure on the high seas. Follow the journey of a young pirate making a promise to protect his crew. The images evoke the salty breeze and the thrill of the open ocean.",
  },
  {
    id: "2",
            ...
            >
              ...
              >
                <Search>
                  ...
                  <StyledInputBase
                    placeholder={
                      isMobile ? "Search" : "What would you like to search?"
                    }
